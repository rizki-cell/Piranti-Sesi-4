  ...
  factory Welcome.fromMap(Map<String, dynamic> map) {
    return Welcome(
      ...
      currentUserCollections:
          List<dynamic>.from(map['current_user_collections']),
...
class TopicSubmissions {
  ...
  factory TopicSubmissions.fromMap(Map<String, dynamic> map) {
    return TopicSubmissions(
      health:
          map['health'] != null ? The3DRenders.fromMap(map['health']) : null,
      the3DRenders: map['the_3d_renders'] != null
          ? The3DRenders.fromMap(map['the_3d_renders'])
          : null,
      nature:
          map['nature'] != null ? The3DRenders.fromMap(map['nature']) : null,
      ...
      experimental: map['experimental'] != null
          ...
          : null,
      sports:
          map['sports'] != null ? The3DRenders.fromMap(map['sports']) : null,
    );
  }
